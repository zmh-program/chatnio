  ...
  en: {
    translation: {
      ...
      sub: {
        ...
        "free-api": "API calls",
        "pro-gpt4": "GPT-4 200 requests per day",
  ...
  ru: {
    translation: {
      ...
      pkg: {
        ...
        "cert-desc":
          "После сертификации подлинности вы можете получить 200 очков (стоимостью 5 CNY)",
      ...
      sub: {
        ...
        "free-api": "API вызовы",
        "pro-gpt4": "GPT-4 200 запросов в день",
